...
where permission.name = 'Gerir Sistema'
and profile.id_profile = v_id_profile;
...
-- insert into adotame.catalog_animal(id_animal, id_catalog) values(41, 3);
-- insert into adotame.catalog_animal(id_animal, id_catalog) values(42, 3);
...
-- insert into adotame.request_type(id_request_type, name) values(3, 'Adotar');
-- insert into adotame.request_type(id_request_type, name) values(4, 'Apadrinhar');
-- insert into adotame.request_type(id_request_type, name) values(5, 'Adicionar Animal');